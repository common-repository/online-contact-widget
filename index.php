...
define('ONLINE_CONTACT_WIDGET_VERSION', '1.1.0');
...
function wb_plugin_load_textdomain()
{
    load_plugin_textdomain('wb-ocw', false, plugin_basename(ONLINE_CONTACT_WIDGET_PATH) . '/languages/');
}
add_action('plugins_loaded', 'wb_plugin_load_textdomain');
